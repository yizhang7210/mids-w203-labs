...
dem_df <- within(dem_df, Harris[Harris > 100] <- 100)
dem_df <- within(dem_df, Biden[Biden > 100] <- 100)
dem_df <- within(dem_df, Harris[Harris < 0] <- 0)
dem_df <- within(dem_df, Biden[Biden < 0] <- 0)
