...
positive for COVID-19. Our driving research question is, "Are survey respondents 
who have had someone in their home infected by COVID-19 more likely to 
...
```{r, echo = FALSE}
# This code takes a few minutes to run, so it is commented out to allow for
# faster knitting
